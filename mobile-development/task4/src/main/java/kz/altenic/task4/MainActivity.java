...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            idTopic = savedInstanceState.getInt(ID_TOPIC, R.id.overview);
        } else {
            ...
            idTopic = sPref.getInt(ID_TOPIC, R.id.overview);
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        // Блок выбора тем
        if (id == R.id.overview) {
            webView.loadUrl(resourceDir + "overview/index.html");
        } else if (id == R.id.module1) {
            webView.loadUrl(resourceDir + "module1/index.html");
        } else if (id == R.id.module2) {
            webView.loadUrl(resourceDir + "module2/index.html");
        } else if (id == R.id.module3) {
            webView.loadUrl(resourceDir + "module3/index.html");
        } else if (id == R.id.module4) {
            webView.loadUrl(resourceDir + "module4/index.html");
        } else if (id == R.id.module5) {
            webView.loadUrl(resourceDir + "module5/index.html");
        } else if (id == R.id.module6) {
            webView.loadUrl(resourceDir + "module6/index.html");
        } else if (id == R.id.module7) {
            webView.loadUrl(resourceDir + "module7/index.html");

            // Блок внешних переходов
        } else {
            if (id == R.id.video1) {
                openLinkExternally(getString(R.string.video1));
            }
            if (id == R.id.video2) {
                openLinkExternally(getString(R.string.video2));
            }
            if (id == R.id.nav_view1) { // Переход на внешнюю html-ссылку и внешний браузер
                openLinkExternally(getString(R.string.web_link));
            }
            if (id == R.id.nav_view2) { // Переход на внешнюю html-ссылку и внешний браузер
                openLinkExternally(getString(R.string.kz_link));
            }
